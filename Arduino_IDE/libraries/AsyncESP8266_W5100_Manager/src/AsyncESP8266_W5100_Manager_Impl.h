/****************************************************************************************************************************
  AsyncESP8266_W5100_Manager_Impl.h
  ...
  ------- -----------  ---------- -----------
  1.0.0   K Hoang     10/12/2022 Initial coding for ESP8266_W5100
 *****************************************************************************************************************************/

#pragma once

#ifndef AsyncESP8266_W5100_Manager_Impl_h
#define AsyncESP8266_W5100_Manager_Impl_h
...
/**
   ...
   @access public
*/
ESPAsync_EMParameter** AsyncESP8266_W5100_Manager::getParameters()
{
  return _params;
}
...
/**
   ...
   @access public
*/
int AsyncESP8266_W5100_Manager::getParametersCount()
{
  return _paramsCount;
}
...
char* AsyncESP8266_W5100_Manager::getRFC952_hostname(const char* iHostname)
{
...
AsyncESP8266_W5100_Manager::AsyncESP8266_W5100_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver,
...
AsyncESP8266_W5100_Manager::~AsyncESP8266_W5100_Manager()
{
#if USE_DYNAMIC_PARAMS
...
#if USE_DYNAMIC_PARAMS
  bool AsyncESP8266_W5100_Manager::addParameter(ESPAsync_EMParameter *p)
#else
  void AsyncESP8266_W5100_Manager::addParameter(ESPAsync_EMParameter *p)
#endif
{
#if USE_DYNAMIC_PARAMS
...
void AsyncESP8266_W5100_Manager::setupConfigPortal()
{
  ...
  server->on("/",         std::bind(&AsyncESP8266_W5100_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/eth",     std::bind(&AsyncESP8266_W5100_Manager::handleETH,        this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/ethsave", std::bind(&AsyncESP8266_W5100_Manager::handleETHSave,    this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/close",    std::bind(&AsyncESP8266_W5100_Manager::handleServerClose, this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/i",        std::bind(&AsyncESP8266_W5100_Manager::handleInfo,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/r",        std::bind(&AsyncESP8266_W5100_Manager::handleReset,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/state",    std::bind(&AsyncESP8266_W5100_Manager::handleState,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
  server->on("/fwlink",   std::bind(&AsyncESP8266_W5100_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->onNotFound (std::bind(&AsyncESP8266_W5100_Manager::handleNotFound,        this, std::placeholders::_1));
...
bool AsyncESP8266_W5100_Manager::startConfigPortal()
{
  connect = false;
...
void AsyncESP8266_W5100_Manager::setTimeout(const unsigned long& seconds)
{
...
void AsyncESP8266_W5100_Manager::setConfigPortalTimeout(const unsigned long& seconds)
{
...
void AsyncESP8266_W5100_Manager::setConnectTimeout(const unsigned long& seconds)
{
  _connectTimeout = seconds * 1000;
}

void AsyncESP8266_W5100_Manager::setDebugOutput(bool debug)
{
  _debug = debug;
}
...
void AsyncESP8266_W5100_Manager::setBreakAfterConfig(bool shouldBreak)
{
...
void AsyncESP8266_W5100_Manager::reportStatus(String& page)
{
...
void AsyncESP8266_W5100_Manager::setSTAStaticIPConfig(const IPAddress& ip, const IPAddress& gw, const IPAddress& sn)
{
...
void AsyncESP8266_W5100_Manager::setSTAStaticIPConfig(const ETH_STA_IPConfig& EM_STA_IPconfig)
{
  LOGINFO(F("setSTAStaticIPConfig"));
...
void AsyncESP8266_W5100_Manager::getSTAStaticIPConfig(ETH_STA_IPConfig& EM_STA_IPconfig)
{
...
void AsyncESP8266_W5100_Manager::handleRoot(AsyncWebServerRequest *request)
{
...
void AsyncESP8266_W5100_Manager::handleETH(AsyncWebServerRequest *request)
{
...
void AsyncESP8266_W5100_Manager::handleETHSave(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("ETH save"));
...
void AsyncESP8266_W5100_Manager::handleServerClose(AsyncWebServerRequest *request)
{
...
void AsyncESP8266_W5100_Manager::handleInfo(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Info"));
  ...
  page += F("<p/>More information about AsyncESP8266_W5100_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/AsyncESP8266_W5100_Manager\">https://github.com/khoih-prog/AsyncESP8266_W5100_Manager</a>");
  page += FPSTR(EM_HTTP_END);
...
void AsyncESP8266_W5100_Manager::handleState(AsyncWebServerRequest *request)
{
...
void AsyncESP8266_W5100_Manager::handleReset(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Reset"));
...
void AsyncESP8266_W5100_Manager::handleNotFound(AsyncWebServerRequest *request)
{
  if (captivePortal(request))
  {
...
*/
bool AsyncESP8266_W5100_Manager::captivePortal(AsyncWebServerRequest *request)
{
...
void AsyncESP8266_W5100_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void AsyncESP8266_W5100_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool AsyncESP8266_W5100_Manager::isIp(const String& str)
{
...
// IP to String
String AsyncESP8266_W5100_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // AsyncESP8266_W5100_Manager_Impl_h
